            ...
            steps {
                script {
                    ...
                    sshpass -p "D3sarrollo.portal" ssh desarrollo@192.168.9.53 "
                        ...
                        echo 'D3sarrollo.portal' | sudo -S docker compose exec php php ./vendor/bin/pint --dirty --verbose &&
                        echo 'D3sarrollo.portal' | sudo -S docker compose exec -u root php php ./vendor/bin/pint
                    "
                    '''
                    sh '''
