...
<div>
    ...
    <div class="caja-flex mision-vision-cert">
        ...
        <div class="cert-valor cert-mision">
            ...
            <div class="cert-icon">
                <img src="img/cert_vision.webp" title="Misión CERT">
                <h2 class="title-five">Misión</h2>
            </div>
        </div>
        <div class="cert-valor cert-vision">
            <div class="cert-icon">
                <img src="img/cert_vision.webp" title="Visión CERT">
    ...
    <h2 class="title-main objetivos-cert">Objetivos de un CERT</span>
        ...
        <img src="img/servicio_cert.webp" class="servicio-img no-visible" title="Servicios del CERT">

        <hr style="width: 500px; border-color:#fff; margin-top:80px;">

        <h2 class="title-second title-somm">Somos miembros</h2>

        <img src="img/first.webp" class="first-img no-visible" title="CERT certificado por FIST">
        ...
        <content class="content-limit">
            ...
            <img src="img/estandares.webp" class="estandares-img no-visible" title="Esquema TLP">
