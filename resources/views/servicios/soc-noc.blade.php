...
<div>
    <div class="title-fondo">
        <img src="{{asset('img/serv_monitor.webp')}}" height="70px" style="filter: brightness(10);">
        <h1>SOC / NOC</h1>
    ...
    <content class="content-limit">
        <div class="caja-serv-inter">
            ...
            <div class="main-serv-inter">
                <h1 class="title-first-serv">¿Por qué instalar un SOC?</h1>
                ...
                <h1 class="title-first-serv">SERVICIOS DE MONITOREO DE INFRAESTRUCTURA (NOC)</h1>
                <p>
