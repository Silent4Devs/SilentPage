...
return [
    ...
    'header_weare_desc' => 'Through a specialized team, we aim to be a reliable reference in research, assistance, and dissemination activities related to the management and response to security incidents.',
    ...
    'product_1' => [
        ...
        'features2' => [
            'one' => 'Emails',
            'two' => 'Files',
            'three' => 'Cyber Threat Alert',
            'four' => 'Vulnerabilities',
            'five' => 'Technological Notifications',
            'six' => 'Industrial Notifications',
        ],
    ],
    'product_2' => [
