...
return [
    ...
    'contenido' => [
        ...
        'tipos_de_datos' => [
            ...
            'paragraphs' => [
                'parrafo1' => 'Personal Data: full name; email address; phone numbers (work and/or mobile); official identification, Federal Taxpayer Registry (RFC); commercial and/or personal references.',
                'parrafo2' => 'Sensitive Asset Personal Data: bank account data (bank institution, account number, interbank CLABE, and branch).',
            ],
        ],
        ...
        'cookies' => [
            ...
            'paragraphs' => [
                'parrafo1' => 'To obtain more information about you, we may use cookies, web beacons, and/or similar technological elements to gather information such as: browser type and operating system; web pages you visit; links you follow; IP address; sites you visited before entering ours; user recognition; detecting outstanding information; and measuring traffic parameters.',
                'parrafo2' => 'These technologies can be disabled using the procedures provided at the following links according to the type of browser you use:',
            ],
            'links' => [
                'Microsoft_Edge' => 'https://privacy.microsoft.com/en-US/windows-10-microsoft-edge-and-privacy',
                ...
                'Safari for iPad, iPhone, and iPod Touch' => 'https://support.apple.com/en-us/HT201265',
                'Safari for MAC' => 'https://support.apple.com/kb/ph21411?locale=en_US',
        ...
        'otros' => [
            ...
            'paragraphs' => [
                ...
                'parrafo5' => 'You have the right to access, rectify, and cancel your Personal Data, to object to its processing, or to revoke your consent (collectively referred to as “ARCO Rights”). To do so, you must submit a written request for the exercise of ARCO Rights addressed to the Information Security Department of “SILENT4BUSINESS,” responsible for the protection of Personal Data, located at the address indicated above, or by email to privacidad@silent4business.com (“Request”); you must receive acknowledgment of receipt in both cases for “S4B” to be bound in this regard. Such Request must contain the following information: full name; email address for notifications; a simple copy of an official photo ID, a clear and precise description of the Personal Data concerning which you seek to exercise ARCO Rights; description of any element or document that facilitates locating your Personal Data; and the signature of the Request.',
                'parrafo6' => 'If requesting the exercise of the right of: Rectification, you must indicate the modifications to be made and provide the documentation supporting the request; and Access; “S4B” will provide Personal Data via email and/or by appointment at corporate offices, at the choice of “S4B.”',
                'parrafo7' => 'Within a maximum of 20 (twenty) business days from the acknowledgment of receipt of the Request, the petition must be addressed, and you will be informed of its acceptance or rejection through a notice sent to the email provided for notifications. If your Request is deemed valid, “S4B” must implement it within 15 (fifteen) business days, counting from the receipt of the acceptance of your Request via email.',
                'parrafo8' => 'Additionally, concerning Secondary Purposes, you have the right to revoke or express your refusal to process your Personal Data; and/or to be included in the “Exclusion List” enabled and owned by “S4B,” which allows us to limit the use and disclosure of Personal Data. For both purposes, simply send us the revocation or exclusion request, which must include: full name; and email account to respond to your request. This must be addressed to the Security Department of “S4B,” responsible for the protection of Personal Data, at the following email: privacidad@silent4business.com. An acknowledgment of receipt must be provided for “SILENT4BUSINESS” to be bound in this regard. The acknowledgment of receipt includes evidence of revocation and/or registration in the “Exclusion List.” “S4B” has a maximum period of 5 (five) business days to respond.',
