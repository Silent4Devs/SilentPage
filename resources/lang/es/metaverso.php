...
return [
    ...
    'desc_3' => [
        'step_1' => 'En resumen: W, A, S y D: Teclas para moverte en diferentes direcciones.',
        'step_2' => 'SHIFT: Tecla para correr si la combinas con las teclas W, A, S y D.',
        'step_3' => 'SPACE BAR: Tecla para brincar FLECHAS: Teclas para girar la cámara.',
        'step_4' => 'CLIC con mouse: Podrás teletransportarte al lugar seleccionado.',
        'step_5' => 'Números del 1 al 5: Podrás expresarte en el multiverso, aplaudir, saludar, aprobar o bailar.',
    ],
    'title_4' => 'Cuando veas a un guía como el de la imagen siguiente, da clic sobre el/ella para que te de información valiosa de Silent.',
    'title_5' => 'Para reproducir un video o ver de cerca los cuadros de la pared, da clic sobre la lupa que aparece en la esquina.',
    'title_6' => 'Por último, podrás escribir en el chat para platicar con otras personas que se encuentren en la sala, no olvides ser respetuso.',
    'finish' => '¡Ya estás listo para disfrutar del Metaverso de Silent 4 Business!, ingresa dando clic en el siguiente botón:',
];
