...
return [
    ...
    'meta_desc' => 'Aviso de privacidad.',
    'company_name' => 'SILENT4BUSINESS. S.A. DE C.V.',
    'body_class' => 'terminos-body',
    'header_title' => 'AVISO DE PRIVACIDAD',
    'header_desc' => 'SILENT4BUSINESS, S.A. DE C.V. se compromete a proteger su privacidad y seguridad en el manejo de sus datos personales. A continuación, encontrará la información relevante sobre cómo tratamos sus datos personales.',

    'contenido' => [
        'introduccion' => [
            'title' => 'La protección de sus datos personales es muy importante para SILENT4BUSINESS.',
            'paragraphs' => [
                'parrafo' => 'La protección de sus datos personales es muy importante para SILENT4BUSINESS, S.A. DE C.V., (en adelante
        ...
        'cookies' => [
            ...
            'links' => [
                ...
                'Mozilla Firefox' => 'http://support.mozilla.org/es/kb/Habilitar%20y%20deshabilitar%20cookies?s=deshabilitar+cookies&r=0&e=es&as=s',
                'Opera' => 'http://help.opera.com/Windows/11.50/es-ES/cookies.html',
                'Safari para iPad, iPhone y iPod Touch' => 'https://support.apple.com/es-es/HT201265',
                'Safari para MAC' => 'https://support.apple.com/kb/ph21411?locale=es_MX',
                'Chrome' => 'http://support.google.com/chrome/bin/answer.py?hl=es&answer=95647',
            ],
        ],
        'otros' => [
            'title' => 'Información Adicional sobre el Tratamiento de Datos Personales',
            'paragraphs' => [
                'parrafo1' => 'Entendemos que, los datos personales de terceros (tales como referencias personales y/o comerciales) que usted nos proporcione, ya cuentan con la autorización de su titular para ser entregados y tratados por nosotros conforme al presente aviso de privacidad.',
                'parrafo2' => 'Los fines primarios aplicables a los Datos Personales (los “Fines Primarios”) serán: identificarlo como cliente o proveedor; elaborar documentos, contratos, convenios, facturas, recibos y/o documentación vinculada con la relación; recibir y/o procesar pagos; almacenamiento; y dar cumplimiento a términos y condiciones que hayamos establecido con usted.',
                'parrafo3' => 'Los fines secundarios aplicables a los Datos Personales (los “Fines Secundarios”) serán: estadística; mercadeo y prospección.',
                'parrafo4' => 'Los Datos Personales y la confidencialidad de los mismos están protegidos por medidas de seguridad administrativas, técnicas y/o físicas, para evitar daño, pérdida, alteración, destrucción, uso, acceso o divulgación indebida, por ejemplo los Datos Personales se encuentran en una base de datos interna, cuya administración es a través de claves de acceso que cambian en forma periódica y cuyo acceso está restringido a personas autorizadas; convenios de confidencialidad con su personal, entre otras.',
                'parrafo5' => 'Usted tiene derecho al acceso, rectificación y cancelación de sus Datos Personales, a oponerse al tratamiento de los mismos o a revocar su consentimiento (en su conjunto “Derecho(s) ARCO”). Para ello, es necesario que usted presente una solicitud por escrito del ejercicio del Derecho ARCO dirigida al Departamento de Seguridad de la Información “SILENT4BUSINESS”, responsable de la protección de Datos Personales, ubicado en el domicilio antes indicado, o bien, se comunique vía correo electrónico a privacidad@silent4business.com (“Solicitud”); debiendo recibir en ambos casos acuse de recibo para que “S4B” quede vinculado al respecto. Dicha Solicitud deberá contener la siguiente información: nombre completo; dirección de correo electrónico para recibir notificaciones; copia simple de la identificación oficial con fotografía, descripción clara y precisa de los Datos Personales respecto de los cuales busque ejercer algunos de los Derechos ARCO; descripción de cualquier elemento o documento que facilite la localización de sus Datos Personales; y firma de la Solicitud.',
                'parrafo6' => 'En caso de solicitar el ejercicio del derecho de: Rectificación, deberá indicar las modificaciones a realizar y proporcionar la documentación que acredite y sustente la petición; y Acceso; “S4B” proporcionará los Datos Personales vía correo electrónico y/o mediante cita en oficinas corporativas, a elección de “S4B”.',
                'parrafo7' => 'En un plazo máximo de 20 (veinte) días hábiles contados a partir del acuse de recepción de la Solicitud, se deberá atender la petición e informársele sobre la procedencia o improcedencia de la misma mediante un aviso enviado al correo electrónico proporcionado para recibir la notificación. En caso de resultar procedente su Solicitud, “S4B” deberá hacerla efectiva dentro de los 15 (quince) días hábiles siguientes, contados a partir de la recepción vía correo electrónico de la procedencia de su Solicitud.',
                'parrafo8' => 'En adición, al procedimiento para el ejercicio del Derecho ARCO, usted tiene derecho, con relación a los Fines Secundarios a: revocar o manifestar su negativa para tratar sus Datos Personales; y/o ser incluido en el “Listado de Exclusión” habilitado y propio de “S4B” que nos permite limitar el uso y divulgación de Datos Personales. Para ambos efectos basta nos envíe, la solicitud para revocar o ser excluidos, la cual deberá contener: nombre (s) y apellidos; y cuenta de correo electrónico para responder su solicitud, está deberá ser dirigida al Departamento de Seguridad de “S4B”, responsable de la protección de Datos Personales, al siguiente correo electrónico privacidad@silent4business.com debiendo recibir acuse de recibo para que “SILENT4BUSINESS” quede vinculado al respecto. El acuse de recibo incluye constancia de revocación y/o de inscripción al “Listado de Exclusión”. “S4B” tiene un plazo máximo de 5 (cinco) días hábiles para dar respuesta.',
